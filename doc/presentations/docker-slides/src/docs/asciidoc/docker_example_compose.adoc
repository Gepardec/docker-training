...
version: '3'
services:
include::./examples/compose/docker-compose.yml[tag=db]
----
...
[source, bash]
-----
include::./examples/compose/commands.sh[tag=backup]
-----
...
[source, bash]
-----
include::./examples/compose/commands.sh[tag=restore]
-----
...
services:
  todo-db:
include::./examples/compose/docker-compose-health.yml[tag=dbhealth]
----
...
services:
  todo-app:
include::./examples/compose/docker-compose-health.yml[tag=apphealth]
----
...
* Provide properties with each values to infras
...
[source, bash]
-----
include::./examples/compose/commands.sh[tag=cleanup]
-----